'''
code checked out from https://github.com/austinschneider/MCLLH,
to compare implementation of the effective likelihood
'''
...
def LEff(k, weight_sum, weight_sq_sum):
    ...
    if weight_sum <= 0 or weight_sq_sum < 0:
        if k == 0:
            ...
            #workaround for -inf (case where there can be a data event in the bin but no mc events)
            return -690
